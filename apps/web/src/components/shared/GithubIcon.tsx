...
// Local mark rather than lucide's `Github`, which is deprecated — lucide is
// dropping brand icons, so this keeps the CTA off a moving target.
function GithubIcon({
	size = 16,
	...props
